 ...
 *
 */
public class DriveForInches extends Command {
	CANTalon left;
	CANTalon right;
	double inches ;
	double speed;
    ...
    public DriveForInches(double inches ) {
...
//    	
    ...
    protected void execute() {
    	Robot.driveTrain.driveSet(inches*12*.64);
...
//    	}
    ...
    protected boolean isFinished() {
        ...
        if(Robot.driveTrain.motorL1.getPosition() < ((inches *.64)+.1) && Robot.driveTrain.motorL1.getPosition() > ((inches *.64)-.1) ){
