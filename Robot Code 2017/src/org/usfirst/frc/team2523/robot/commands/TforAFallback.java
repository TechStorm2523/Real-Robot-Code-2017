 ...
 *
 */
public class TforAFallback extends Command {
    ...
    public TforAFallback(double feet, double speed) {
    ...
    protected void initialize() {
    	...
    	Robot.driveTrain.driveSet(speed); //Change this to individual if robot spins around
    	Timer.delay(time2go);
